...
def select_file_dialog() -> str:
    """Open a native file dialog to select a .tcx file.
...
def select_folder_dialog() -> str:
    """Open a native folder dialog to select a directory.

    Returns:
        The selected folder path as a string, or an empty string.
    """
    import tkinter as tk
    from tkinter import filedialog
    try:
